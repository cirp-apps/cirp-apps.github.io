...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20211126_CIRPWP_b5f5a1de66ad28951548_20211126153448_archive.zip';
	const ARCHIVE_SIZE		 = '115641630';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = 'b5f5a1d-26153448';
    const SECONDARY_PACKAGE_HASH = '4c40514-26153448';
	const VERSION			 = '1.4.3';
