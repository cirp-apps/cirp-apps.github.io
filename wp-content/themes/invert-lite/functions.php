...
if( !function_exists('invert_page_admin_enqueue_scripts') ){
    add_action('admin_enqueue_scripts','invert_page_admin_enqueue_scripts');
    /**
     * Register scripts for admin panel
     * @return void
     */
    function invert_page_admin_enqueue_scripts(){	
		wp_enqueue_script('invert-admin-js', get_template_directory_uri() .'/SketchBoard/js/admin-jqery.js', array('jquery'));
    }
}
