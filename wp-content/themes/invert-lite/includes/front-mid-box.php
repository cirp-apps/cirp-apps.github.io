		...
		<div class="mid-box span4"  >	  
			<div class="skt-iconbox iconbox-top">			
				<div class="iconbox-icon skt-animated small-to-large skt-viewport">			
					...
					<a href="<?php if(sketch_get_option($invert_shortname."_fb1_first_part_link")) { echo sketch_get_option($invert_shortname."_fb1_first_part_link"); } ?>" title="FB-first">
		...
		<div class="mid-box span4" >
			<div class="skt-iconbox iconbox-top">			
				<div class="iconbox-icon skt-animated small-to-large skt-viewport">			
					...
					<a href="<?php if(sketch_get_option($invert_shortname."_fb2_second_part_link")) { echo sketch_get_option($invert_shortname."_fb2_second_part_link"); } ?>" title="FB-second">
		...
		<div class="mid-box span4" >
			<div class="skt-iconbox iconbox-top">			
				<div class="iconbox-icon skt-animated small-to-large skt-viewport">			
					...
					<a href="<?php if(sketch_get_option($invert_shortname."_fb3_third_part_link")) { echo sketch_get_option($invert_shortname."_fb3_third_part_link"); } ?>" title="FB-third">
