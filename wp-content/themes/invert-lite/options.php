...
function optionsframework_options() {
	...
	$options[] = array(
	   ...
	   $options[] = array(
			...
			'desc' => __('Choose breadcrumb background type.', 'invert'),
       ...
       $options[] = array(
			...
			'desc' => __('Choose breadcrumb background color.', 'invert'),
       ...
       $options[] = array(
			'name' => __('Custom Breadcrumb Background Image:', 'invert'),
			'desc' => __('Choose image for breadcrumb background. Size: Width 1600px and Height 450px.', 'invert'),
